...
export function KpiCard({
  ...
  if (gradient) {
    const GRADIENT_MAP: Record<string, string> = {
      ...
      amber:  'linear-gradient(135deg, #6366F1, #4F46E5)',
      blue:   'linear-gradient(135deg, #6366F1, #4F46E5)', // remap blue→amber
      indigo: 'linear-gradient(135deg, #6366F1, #4F46E5)', // remap indigo→amber
    };
    ...
    return (
      <div className="rounded-xl p-5 shadow-sm"
        ...
        <p className="text-xs font-medium uppercase tracking-wider"
          style={{ color: '#6366F1', letterSpacing: '0.05em' }}>{label}</p>
